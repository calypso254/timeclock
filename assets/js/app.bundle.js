(() => {
  ...
  const ShippingQueuePanel = ({
    ...
    if (!showActions) {
      return /* @__PURE__ */ React.createElement("div", { className: "section-width flex flex-col h-auto min-h-0 animate-fade-in" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-3 shrink-0" }, /* @__PURE__ */ React.createElement("div", null, eyebrow && /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#16a34a]" }, eyebrow), /* @__PURE__ */ React.createElement("h3", { className: `section-title ${eyebrow ? "mt-1" : ""}` }, title), subtitle && /* @__PURE__ */ React.createElement("p", { className: "section-subtitle mt-1" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: `status-chip public-overview-status-chip self-start md:self-auto ${statusClass}` }, queueStatus)), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-rows" }, /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.manifestCount ?? manifests.length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Manifests")), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.batchCount ?? batches.length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Batches")), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.completedCount ?? [...manifests, ...batches].filter((item) => item.isComplete).length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Completed"))));
    }
