(() => {
  ...
  const PublishedSchedulePanel = ({
    ...
    const visiblePublishedRows = normalizedHighlightName ? publishedRows.filter((row) => String(row.name || "").trim() === normalizedHighlightName) : publishedRows;
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section-width flex flex-col h-full animate-fade-in overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3 mb-4 shrink-0 px-1 pt-1" }, /* @__PURE__ */ React.createElement("div", null, eyebrow && /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#38bdf8]" }, eyebrow), /* @__PURE__ */ React.createElement("h3", { className: `section-title ${eyebrow ? "mt-1" : ""}` }, title), subtitle && /* @__PURE__ */ React.createElement("p", { className: "section-subtitle mt-1" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 bg-white border-2 border-black rounded-xl p-1 shadow-[2px_2px_0px_0px_#000000] h-12" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setCurrentWeekStart((prev) => addDaysToLocalDate(prev, -7)), className: "w-10 h-10 flex items-center justify-center rounded-lg hover:bg-gray-100 text-[#060606] transition-colors font-bold font-poppins text-lg" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-chevron-left" })), /* @__PURE__ */ React.createElement("span", { className: "font-bold font-poppins text-[#060606] min-w-[170px] md:min-w-[210px] text-center text-sm md:text-base px-2" }, formatWeekRangeLabel(currentWeekStart)), /* @__PURE__ */ React.createElement("button", { onClick: () => setCurrentWeekStart((prev) => addDaysToLocalDate(prev, 7)), className: "w-10 h-10 flex items-center justify-center rounded-lg hover:bg-gray-100 text-[#060606] transition-colors font-bold font-poppins text-lg" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-chevron-right" }))))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 overflow-y-auto no-scrollbar px-1 pb-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, visibleWeeks.map((week, weekIndex) => /* @__PURE__ */ React.createElement("div", { key: normalizeDate(week.startDate), className: "section-card panel-content-card bg-[#fffdf5]" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#38bdf8]" }, "Week ", weekIndex + 1), /* @__PURE__ */ React.createElement("h4", { className: "card-title mt-1" }, formatWeekRangeLabel(week.startDate))), /* @__PURE__ */ React.createElement("div", { className: "text-left md:text-right" }, /* @__PURE__ */ React.createElement("div", { className: "card-meta" }, week.shiftCount, " published shift", week.shiftCount === 1 ? "" : "s"), showTimeOffRequestHint && /* @__PURE__ */ React.createElement("div", { className: "card-meta mt-1 text-[#38bdf8]" }, "Tap the date to request time off."))), /* @__PURE__ */ React.createElement("div", { className: "schedule-week-grid employee-schedule-grid" }, week.days.map((dayObj) => {
      ...
      const personalCardTitle = timeOffRow ? getTimeOffStatusLabel(timeOffRow) : String(personalShift?.name || normalizedHighlightName || "").trim();
  ...
  const ShippingQueuePanel = ({
    ...
    const readyDocumentCount = Number(summary.readyDocumentCount ?? manifests.filter((item) => !item.isComplete).length + batches.filter((item) => !item.isComplete && item.isReady).length * 2);
    ...
    if (!showActions) {
      return /* @__PURE__ */ React.createElement("div", { className: "section-width flex flex-col h-auto min-h-0 animate-fade-in" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-3 shrink-0" }, /* @__PURE__ */ React.createElement("div", null, eyebrow && /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#16a34a]" }, eyebrow), /* @__PURE__ */ React.createElement("h3", { className: `section-title ${eyebrow ? "mt-1" : ""}` }, title), subtitle && /* @__PURE__ */ React.createElement("p", { className: "section-subtitle mt-1" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: `status-chip public-overview-status-chip self-start md:self-auto ${statusClass}` }, displayQueueStatus)), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-rows" }, /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.manifestCount ?? manifests.filter((item) => !item.isComplete).length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Manifests")), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.shippingLabelCount ?? batches.filter((item) => !item.isComplete && item.isReady).length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Shipping Labels")), /* @__PURE__ */ React.createElement("div", { className: "shipping-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-count" }, summary.packingSlipCount ?? batches.filter((item) => !item.isComplete && item.isReady).length), /* @__PURE__ */ React.createElement("span", { className: "shipping-summary-label" }, "Packing Slips"))));
    }
    return /* @__PURE__ */ React.createElement("div", { className: "section-width flex flex-col h-auto min-h-0 animate-fade-in" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-3 shrink-0" }, /* @__PURE__ */ React.createElement("div", null, eyebrow && /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#16a34a]" }, eyebrow), /* @__PURE__ */ React.createElement("h3", { className: `section-title ${eyebrow ? "mt-1" : ""}` }, title), subtitle && /* @__PURE__ */ React.createElement("p", { className: "section-subtitle mt-1" }, subtitle)), /* @__PURE__ */ React.createElement("div", { className: `status-chip public-overview-status-chip self-start md:self-auto ${statusClass}` }, displayQueueStatus)), itemCount > 0 ? /* @__PURE__ */ React.createElement("div", { className: "shipping-item-list" }, manifests.map(renderManifest), batches.map(renderBatch)) : /* @__PURE__ */ React.createElement("div", { className: "shipping-empty-state" }, "No shipping documents are ready."), showMeta && (updatedLabel || queue.notes) && /* @__PURE__ */ React.createElement("div", { className: "card-meta mt-3" }, updatedLabel && /* @__PURE__ */ React.createElement("span", null, "Updated ", updatedLabel), updatedLabel && queue.notes && /* @__PURE__ */ React.createElement("span", null, " \xB7 "), queue.notes && /* @__PURE__ */ React.createElement("span", null, queue.notes)));
  };
  ...
  const AdminPayrollWorkspace = ({
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "section-width flex flex-col h-full min-h-0 animate-fade-in overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col xl:flex-row xl:items-start xl:justify-between gap-4 mb-4 shrink-0" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-[#38bdf8]" }, roleLabel), /* @__PURE__ */ React.createElement("h3", { className: "section-title mt-1" }, "Payroll Period Hours")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2 shadow-safe-4" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 lg:grid-cols-[minmax(0,1fr)_180px_180px] lg:items-center" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "card-title text-base md:text-lg xl:text-xl leading-tight break-words" }, period.label), /* @__PURE__ */ React.createElement("div", { className: "card-meta mt-1" }, period.isActive ? "Active period" : "Closed period")), /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border-2 border-black bg-white px-4 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-gray-500" }, "Total Hours"), /* @__PURE__ */ React.createElement("div", { className: "payroll-summary-value mt-1" }, formatPayrollHours(period.totalMinutes))), /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border-2 border-black bg-white px-4 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "card-eyebrow text-gray-500" }, "Pay Date"), /* @__PURE__ */ React.createElement("div", { className: "payroll-summary-value mt-1" }, formatFullDate(period.payDate)))),
      /* @__PURE__ */ React.createElement("div", { className: "mt-4 space-y-2" }, period.employeeSummaries.map((summary) => /* @__PURE__ */ React.createElement("div", { key: `${period.key}-${summary.name}`, className: "rounded-xl border-2 border-black bg-white px-4 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "grid gap-2 md:grid-cols-[minmax(0,1fr)_120px_110px_170px_150px] md:items-center" }, /* @__PURE__ */ React.createElement("div", { className: "payroll-row-text truncate" }, summary.name), /* @__PURE__ */ React.createElement("div", { className: "payroll-row-text text-gray-700" }, formatEntryCount(summary.workedEntryCount)), /* @__PURE__ */ React.createElement("div", { className: "payroll-row-text text-gray-700" }, summary.editedEntryCount, " Edited"), /* @__PURE__ */ React.createElement("div", { className: "payroll-row-text md:text-right" }, "Hours ", formatPayrollHours(summary.totalMinutes)), /* @__PURE__ */ React.createElement("div", { className: "payroll-row-text md:text-right" }, "Pay ", summary.totalPay === null ? "-" : formatCurrencyAmount(summary.totalPay))))))
    )))));
  };
  ...
  function App() {
    ...
    const buildFallbackShippingQueue = (baseQueue = null) => {
      ...
      return {
        ...
        batches,
        summary: {
          manifestCount: Number(base.summary?.manifestCount ?? manifests.filter((item) => !item.isComplete).length),
          batchCount: Number(base.summary?.batchCount ?? batches.filter((item) => !item.isComplete && item.isReady).length),
          packingSlipCount: Number(base.summary?.packingSlipCount ?? batches.filter((item) => !item.isComplete && item.isReady).length),
          shippingLabelCount: Number(base.summary?.shippingLabelCount ?? batches.filter((item) => !item.isComplete && item.isReady).length),
          readyDocumentCount: Number(base.summary?.readyDocumentCount ?? manifests.filter((item) => !item.isComplete).length + batches.filter((item) => !item.isComplete && item.isReady).length * 2),
          ...
          notReadyCount: Number(base.summary?.notReadyCount ?? batches.filter((item) => !item.isComplete && !item.isReady).length)
        },
